...
% - principled data structures
% - aggregating multiple feeds into (nested) logical entities (partially ordered)
%   - how? pki, reusable message patterns
%
% - message type coordination? schemas?
%
% - db layer: causal ordering, indexing
%
% - replication
%   - what happens if we drop the assumption that feeds map to humans?
%   - adversarial context?
%
% - alternate models (unordered feeds, dag feeds)
% - lossy compaction
%
% Future work on social stuff
%
% - privacy! access control
% - separate subscribing to content and access control
% - encrypting stuff by default?
% - replication using private set intersection
%
% - multiple identities
% - (delegating) moderation
% - (delegating) forbidden blobs and messages (the latter assuming offchain-content)
%
% - problems that arise when there's no few-to-one mapping between feeds and humans
