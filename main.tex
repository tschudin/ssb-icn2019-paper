...
SSB apps. An crucial (performance) aspect is incremental indexing
...
Currently the {\small\tt name} and {\small\tt image} attributes are
understood by most SSB user interfaces and are used to substitute or
decorate the cryptographic ID. If {\small\tt target\_id} and
{\small\tt author\_id} are identical, the assignments are self-chosen,
and otherwise given.
