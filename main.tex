...
\begin{abstract}
  ...
  for information-centric networking primitives. We finally discuss
...
of SSB, and a hybrid mode where NDN forwarders are made SSB-aware. Figure~\ref{fig:ssb-and-ndn} illlustrates the
three different scenarios. The purpose is to shed light on the sometimes implicit
assumptions behind SSB and NDN and show a larger design space for future ICN developments.
