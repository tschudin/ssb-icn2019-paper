...
other posts and their replies, which form a directed acyclic graph. Insertion into the dependency graph may or may not lead to having to rerun the sort on the whole graph of
...
how many packets are needed to consume the PIT entry. Feeds (=SSB
...
plus the entry's sequence number. In addition, using our special LLI, a
